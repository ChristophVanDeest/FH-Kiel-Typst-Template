...
This is an **`unofficial`** template for writing a bachelor thesis in the `FH Kiel` department of `Computer Science` design using [Typst](https://github.com/typst/typst).
