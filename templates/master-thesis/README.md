...
This is an **`unofficial`** template for writing a master thesis in the `FH Kiel` department of `Computer Science` design using [Typst](https://github.com/typst/typst).
